  ...
  function move(dir) {
    ...
    if (cell.content) {
      if (cell.roomType === "monstro") {
        ...
        return {
          msg: `${colors.white}${mensagemSecreta}${colors.reset}\n`,
          type: "segredo",
        };
      }
    }
  ...
  function investigate() {
    ...
    if (cell.roomType === "trap") {
      ...
      if (rand(1, 100) <= chance) {
        ...
        let msg = `${colors.green}Você desarmou a armadilha com sucesso!${colors.reset}\n`;
        ...
        return { ok: true, result: "triggered", dano: dano, msg: msg };
      }
    } else if (cell.roomType === "treasure") {
      ...
      if (cont.ouro && cont.ouro > 0) {
        ...
        return {
          ...
          gold: gold,
          item: item,
          msg: `${colors.green}Você encontrou ${colors.yellow}${gold}${colors.reset} ${colors.green}de ouro!${colors.reset}\n`,
        };
      } else {
        return {
          ok: true,
      ...
      if (rand(1, 100) <= 90) {
        ...
        if (rewardType === "ouro") {
          ...
          return {
            ...
            result: "secret",
            gold: g,
            msg: `${colors.green}Você achou um esconderijo com ${colors.yellow}${g}${colors.reset} ${colors.green}de ouro!${colors.reset}\n`,
          };
          ...
          return {
            ...
            result: "secret",
            fragment: 1,
            msg: `${colors.green}Você encontrou um ${colors.magenta}fragmento antigo!${colors.reset}\n`,
          };
        }
      } else {
        return {
          ok: true,
          result: "nothing",
          msg: `${colors.gray}Você não encontrou nada relevante.${colors.reset}\n`,
        };
      }
    } else {
